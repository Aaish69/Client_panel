...
<head>
    ...
    <title>Astute Solutions | Basic Form</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/plugins/iCheck/custom.css">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/plugins/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css">
    ...
    <div id="wrapper">
                ...
                <div class="col-lg-10">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <form class="form-horizontal" method='POST' action="add_client">
                                <p>Enter details of client</p>
                                <div class="form-group"><label class="col-lg-2 control-label">Email</label>

                                    <div class="col-lg-10"><input name="email" placeholder="Email" value="<?php echo set_value('email'); ?>" class="form-control"> <span class="help-block m-b-none">You must enter a valid email address</span>
                                    </div>
                                </div>

                                <div class="form-group"><label class="col-lg-2 control-label">Name</label>

                                    <div class="col-lg-10"><input name="name" placeholder="Name" value="<?php echo set_value('name'); ?>" class="form-control"></div>
                                </div>

                                <div class="form-group"><label class="col-lg-2 control-label">Address</label>

                                    <div class="col-lg-10"><input name="address" placeholder="Address" value="<?php echo set_value('address'); ?>" class="form-control"></div>
                                </div>

                                <div class="form-group"><label class="col-lg-2 control-label">Company</label>

                                    <div class="col-lg-10"><input name="company" placeholder="Company" value="<?php echo set_value('company'); ?>" class="form-control"></div>
                                </div>
        ...
        <div class="footer">
            <div class="pull-right">
                13GB of <strong>17GB</strong> Free.
            </div>
            <div>
                <strong>Copyright</strong> Astute Solutions &copy; 2069-2096
            </div>
        </div>
